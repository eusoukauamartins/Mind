...
export default function FixedCosts() {
  ...
  const projections = useMemo(() => {
    ...
    const initialBalance = parseFloat(localStorage.getItem('cp_initial_balance') || '0');
  ...
  return (
    <div style={{ marginBottom: 'var(--sp-6)' }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 'var(--fs-lg)', color: 'var(--border-strong)', alignSelf: 'center', display: 'flex', alignItems: 'center', height: '100%' }}>—</div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
          ...
          <span style={{ fontSize: 'var(--fs-lg)', fontWeight: 600, color: '#fdcb6e', display: 'flex', alignItems: 'center' }}>
