...
export default function Projects() {
  ...
  return (
    <div className="page-container">
      ...
      <div style={{ display: 'flex', gap: 'var(--sp-2)', marginBottom: 'var(--sp-6)', overflowX: 'auto', paddingBottom: 'var(--sp-2)' }}>
        {TABS.map(tab => (
          <button
            key={tab}
      ...
      {sorted.length === 0 ? (
        <EmptyState
          ...
          description={activeTab === 'Lixeira' ? "A lixeira está vazia." : "Crie um projeto para decompor tarefas complexas em blocos de execução."}
              ...
              <div key={project.id} className="project-card">
                <div className="project-card-header" onClick={() => toggleExpanded(project.id)}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ display: 'flex', gap: 'var(--sp-3)', fontSize: 'var(--fs-xs)', color: 'var(--text-tertiary)', marginTop: '6px' }}>
                  ...
                  <div style={{ display: 'flex', gap: 'var(--sp-1)', flexShrink: 0, alignItems: 'center' }} onClick={e => e.stopPropagation()}>
