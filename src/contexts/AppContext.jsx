    ...
    case COLLECTIONS.TASKS:
      return rawData.map(t => {
        ...
        return {
          ...
          reminderEnabled: t.reminderEnabled !== undefined ? Boolean(t.reminderEnabled) : (t.reminder_enabled !== undefined ? Boolean(t.reminder_enabled) : false),
          reminderAt: String(t.reminderAt !== undefined ? t.reminderAt : (t.reminder_at !== undefined ? t.reminder_at : '')),
          timezone: String(t.timezone !== undefined ? t.timezone : 'America/Sao_Paulo'),
